...
public class Kit6Command extends CommandAPICommand {
    ...
    public Kit6Command(){
        super("k6");
        this.withPermission("vanillacore.k6");
        this.executesPlayer((player, args) -> {
            Kit kit = KitCache.getAllKits(player.getUniqueId()).get(6);
            ...
            player.sendMessage(ColorUtils.parse(prefix + "<gray>You have successfully loaded " + colour + "Kit 6"));
