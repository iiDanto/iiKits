...
public class Kit1Command extends CommandAPICommand {
    ...
    public Kit1Command(){
        super("k1");
        this.withPermission("vanillacore.k1");
        this.executesPlayer((player, args) -> {
            Kit kit = KitCache.getAllKits(player.getUniqueId()).get(1);
            ...
            player.sendMessage(ColorUtils.parse(prefix + "<gray>You have successfully loaded " + colour + "Kit 1"));
