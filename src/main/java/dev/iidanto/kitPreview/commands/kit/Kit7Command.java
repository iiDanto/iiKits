...
public class Kit7Command extends CommandAPICommand {
    ...
    public Kit7Command(){
        super("k7");
        this.withPermission("vanillacore.k7");
        this.executesPlayer((player, args) -> {
            Kit kit = KitCache.getAllKits(player.getUniqueId()).get(7);
            ...
            player.sendMessage(ColorUtils.parse(prefix + "<gray>You have successfully loaded " + colour + "Kit 7"));
