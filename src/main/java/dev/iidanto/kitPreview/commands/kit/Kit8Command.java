...
public class Kit8Command extends CommandAPICommand {
    ...
    public Kit8Command(){
        super("k8");
        this.withPermission("vanillacore.k8");
        this.executesPlayer((player, args) -> {
            Kit kit = KitCache.getAllKits(player.getUniqueId()).get(8);
            ...
            player.sendMessage(ColorUtils.parse(prefix + "<gray>You have successfully loaded " + colour + "Kit 8"));
