...
public class Kit4Command extends CommandAPICommand {
    ...
    public Kit4Command(){
        super("k4");
        this.withPermission("vanillacore.k4");
        this.executesPlayer((player, args) -> {
            Kit kit = KitCache.getAllKits(player.getUniqueId()).get(4);
            ...
            player.sendMessage(ColorUtils.parse(prefix + "<gray>You have successfully loaded " + colour + "Kit 4"));
