...
public class Kit9Command extends CommandAPICommand {
    ...
    public Kit9Command(){
        super("k9");
        this.withPermission("vanillacore.k9");
        this.executesPlayer((player, args) -> {
            Kit kit = KitCache.getAllKits(player.getUniqueId()).get(9);
            ...
            player.sendMessage(ColorUtils.parse(prefix + "<gray>You have successfully loaded " + colour + "Kit 9"));
