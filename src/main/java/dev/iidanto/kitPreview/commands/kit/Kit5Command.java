...
public class Kit5Command extends CommandAPICommand {
    ...
    public Kit5Command(){
        super("k5");
        this.withPermission("vanillacore.k5");
        this.executesPlayer((player, args) -> {
            ...
            player.sendMessage(ColorUtils.parse(prefix + "<gray>You have successfully loaded " + colour + "Kit 5"));
