...
public class Kit2Command extends CommandAPICommand {
    ...
    public Kit2Command(){
        super("k2");
        this.withPermission("vanillacore.k2");
        this.executesPlayer((player, args) -> {
            Kit kit = KitCache.getAllKits(player.getUniqueId()).get(2);
            ...
            player.sendMessage(ColorUtils.parse(prefix + "<gray>You have successfully loaded " + colour + "Kit 2"));
